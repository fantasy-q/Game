  ...
  {/* 其他收集 */
    ...
    children: [
      ...
      },
      {
        ...
        links: [
          { part: 3, time: 1080, text: '亚泰镇：水井' },
          { part: 7, time: 2351, text: '流沙荒漠：???' },
          { part: 10, time: 2722, text: '边远海滩：山洞' },
          { part: 11, time: 2429, text: '丘比特喷泉：雕像' },
          { part: 12, time: 5422, text: '绿洲：水下' },
          { part: 18, time: 6435, text: '流沙古迹：建筑顶部' },
        ]
      },
      {
        h3: { rb: "狗牌", rt: "Dog Tag" },
      ...
      },
      {
        ...
        links: [
          { part: 6, time: 5356, text: '多奇森林：钓鱼​' },
          { part: 19, time: 3429, text: '缪尔洞窟：隐藏区​' },
          { part: 22, time: 5886, text: '奥兰提亚：宝石门' },
          { part: 15, time: 5518, text: '奥兰提亚：推箱子​' },
          { part: 15, time: 7499, text: '世界尽头​：钓鱼', mark: "repeatable" },
          { part: 19, time: 4277, text: '海边悬崖：人鱼​', mark: "repeatable" },
        ]
      },
      {
        h3: { rb: "佩罗", rt: "Perro" },
        links: [
          { part: 16, time: 800, text: '潘瑟罗：平台跳跃' },
          { part: 7, time: 1952, text: '流沙荒漠：塔顶' },
          { part: 16, time: 7175, text: '蒂亚：捉迷藏' },
          { part: 16, time: 7020, text: '普奇牧场：树上' },
          { part: 11, time: 672, text: '高墙之间：绿水晶' },
          { part: 15, time: 2387, text: '禁忌之地：捉迷藏' },
        ]
      },
      {
        h3: { rb: "GEO票卷", rt: "GEO Ticket" },
        links: [
          { part: 6, time: 7649, text: 'GEO 总部：弹弓打开关' },
          { part: 7, time: 164, text: '蒂亚：堆箱子' },
          { part: 9, time: 1913, text: '潘瑟罗：音乐数独' },
          { part: 10, time: 6927, text: '高墙之间：拼图' },
          { part: 12, time: 3179, text: '南大桥：推箱压开关' },
          { part: 12, time: 6265, text: '国王大桥：听声找开关' },
          { part: 14, time: 3770, text: '地底隧道：亮灯问题' },
          { part: 14, time: 4806, text: '蒂亚市：堆箱子' },
          { part: 17, time: 5959, text: '珂赛特：控虫压开关' },
          { part: 18, time: 5296, text: '麦田大道：平台跳跃' },
        ]
      },
      {
    ...
    children: [
      {
        ...
        links: [
          { part: 12, time: 2741, text: '向日葵大道 (旅馆)' },
          { part: 2, time: 5137, text: '阿达尔的家 (床)' },
          { part: 2, time: 2712, text: '亚泰镇：小巷 (床)' },
          { part: 22, time: 6647, text: '亚泰镇 (旅馆)' },
          { part: 17, time: 3956, text: '蒂亚市 (旅馆)​' },
          { part: 12, time: 7295, text: 'GEO总部 (床)​' },
          { part: 9, time: 4015, text: '珂赛特：村长 (床​)' },
          { part: 10, time: 5787, text: '皇家档案馆：尽头 (床​)​' },
          { part: 11, time: 5786, text: '古堡遗址 (草坪)​' },
          { part: 11, time: 1191, text: '最终高墙 (床​)​' },
          { part: 15, time: 6541, text: '特拉鲁姆 (旅馆)​' },
          { part: 20, time: 2244, text: '普利斯汀城​ (床​)' },
          { part: 23, time: 1923, text: '最后休憩点 (床​)' },
        ]
      },
      {
      ...
      },
      {
        ...
        links: [
          { part: 6, time: 5698, text: '向日葵大道：旅馆内​' },
          { part: 8, time: 3525, text: '罗达斯边检站：士兵宿舍​' },
          { part: 7, time: 3698, text: '衔尾蛇据点：右上过道​' },
          { part: 7, time: 6157, text: '湖畔实验室：顶层​' },
          { part: 17, time: 3398, text: '托马斯实验室​：入口处' },
          { part: 5, time: 727, text: '蒂亚市：居民房​' },
          { part: 6, time: 2679, text: '最初高墙：食堂​' },
          { part: 22, time: 7252, text: '麦田大道：入口' },
          { part: 9, time: 4671, text: '普奇牧场：右边房子​' },
        ]
      },
      {
